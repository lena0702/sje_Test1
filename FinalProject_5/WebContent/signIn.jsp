...
<body>
	<form action="SIConfirmC" name="f" onsubmit="return check();"
		method="post" class="signInForm">
		<h2>SignIn Page</h2>
		<div class="Form" id="gaib">
			<input class="inputtext" id="id" name="id" placeholder="ID)3글자 이상">
		</div>
		<div class="Form" id="gaib">
			<input type="password" id="pw" name="pw" class="inputtext"
				placeholder="PW)대문자, 숫자, 5글자 이상">
		</div>
		<div class="Form" id="gaib">
			<input type="password" id="pw2" name="pw2" class="inputtext"
				placeholder="PW재확인">
		</div>
		<div class="Form" id="gaib">
		...
		<div class="Form" id="gaib">
			<input type="text" class="inputNtext" placeholder="성별"
				disabled="disabled"> <select name="gender"><option
					value="남자">남자</option>
				<option value="여자">여자</option></select>
		</div>

		<div class="Form" id="gaib">
			<input id="birth" name="birth" class="inputtext"
				placeholder="생년월일 ex)19990909">
		</div>
		<div class="Form" id="gaib">
			<input type="text" class="inputNNtext" placeholder="좋아하는 장르"
				disabled="disabled"> <select id="fav" name="fav">
